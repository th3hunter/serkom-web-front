...
import { TiposImpuestoTrnComponent } from '../tipos-impuesto-trn/tipos-impuesto-trn.component';
...
@Component({
  selector: 'app-tipos-impuesto-pan',
  templateUrl: './tipos-impuesto-pan.component.html',
  styleUrls: ['./tipos-impuesto-pan.component.scss']
})
export class TiposImpuestoPanComponent implements OnInit, OnDestroy {
    ...
    agregar(): void {
        const dialogRef = this.dialog.open(TiposImpuestoTrnComponent, {
            width: '600px',
            data: {
                mode: 'ins'
            }
    ...
    modificar(): void {
        ...
        const dialogRef = this.dialog.open(TiposImpuestoTrnComponent, {
            ...
            data: {
                mode: 'upd',
                tipoImpuestoId: this.grid.selectedRow.tipoImpuestoId
            }
        });
